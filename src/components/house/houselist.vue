<template>
  <div>
    ...
    <el-card>
      <!-- 面包屑导航区 -->
      <my-bread level1="房源管理" level2="房源列表"></my-bread>
      ...
      <el-table :data="houseList" style="width: 100%;margin-top:20px" border stripe>
          ...
          <template slot-scope="props">
            <el-form label-position="left" inline class="demo-table-expand">
              ...
              <el-form-item label="房间图片：">
                <img :src="props.row.housemainpic" alt="132" width="50px" />
                <img :src="props.row.housemainpic" alt="132" width="50px" />
                <img :src="props.row.housemainpic" alt="132" width="50px" />
                <img :src="props.row.housemainpic" alt="132" width="50px" />
                <img :src="props.row.housemainpic" alt="132" width="50px" />
        ...
        <el-table-column label="房东姓名" prop="ownername" width="120px"></el-table-column>
      </el-table>
      <!-- 分页区域 -->
      <el-pagination
...
export default {
  ...
  filters: {
    fmtstate: function (value) {
      let stateArr = ['待审核', '同意审核', '已出租', '已删除', '拒绝审核']
